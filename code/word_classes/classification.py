...
class Clustering:
    ...
    def best_cluster_number(self, name: str, viz: bool = True) -> Tuple[int, List[int]]:
        silhouette_scores = []
        ...
        if viz:
            ...
            plt.scatter(x=[i for i in range(10, 201)], y=silhouette_scores, s=50, c='#a689c9')
            plt.grid(True)
...
pred_subjects = S.perform_cluster(35, final=True, name='subjects_classes')
pred_verbs = V.perform_cluster(200, final=True, name='verbs_classes')
